...
public final class PasswordAuthentication {
   ...
   public static void storeHashToFile(String hash, String path) {
      StorageHandler sh = new StorageHandler(path);
      sh.saveToTextFile(hash);
   }

   public static String getHashFromFile(String path) {
      StorageHandler sh = new StorageHandler(path);
      return sh.getAllFromFile();
   }
   ...
   /*********
    * For security reasons: prevent common breaches
    */
